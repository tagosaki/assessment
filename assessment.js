...
const mamoruDivided = document.getElementById('mamoru-area');
/**
 * 指定した要素の子要素を全て削除する
...
const answers = [
    ...
    '{userName}のいいところはユニークさです。{userName}だけのその特徴が皆を楽しくさせています。',
...
/*// テストコード
console.log(assessment('前田晃'));
console.log(assessment('前田かおる'));
console.assert(
    assessment('前田晃') === assessment('前田晃'),
